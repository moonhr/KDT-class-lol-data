...
function menuOn(id, isTurnOn) {
  ...
  if (
    menus.name.classList.value === "menu menu100" &&
    menus.line.classList.value === "menu menu100" &&
    menus.cham.classList.value === "menu menu100" &&
    document.getElementById("line").value !== "none"
  ) {
